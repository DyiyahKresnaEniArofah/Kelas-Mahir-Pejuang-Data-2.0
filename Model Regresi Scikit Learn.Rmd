---
title: "Regresi"
author: "Dyiyah Kresna Eni Arofah"
date: "3/29/2021"
...
df<- read.csv("https://raw.githubusercontent.com/DyiyahKresnaEniArofah/Kelas-Mahir-Pejuang-Data-2.0/main/datacontoh.csv",stringsAsFactors = T)
head(df)
```
###Scatter Plot Data
```{r}
...
```{r}
df_1  <- read.csv("https://raw.githubusercontent.com/DyiyahKresnaEniArofah/Kelas-Mahir-Pejuang-Data-2.0/main/datacontoh.csv", stringsAsFactors = T)
head(df_1)
```
